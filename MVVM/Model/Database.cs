namespace ATMApplication.MVVM.Model
{
    public class Database
    {
        ...
        public bool IsCardValid(string cardNumber) => accounts.ContainsKey(cardNumber);

        public string GetCard(string cardNumber) => accounts[cardNumber].CardImage;
        ...
        public decimal GetBalance(string cardNumber, string pin) =>
            IsValidPin(cardNumber, pin) ? accounts[cardNumber].Balance : -1;
        ...
        public string GetName(string cardNumber) => accounts[cardNumber].OwnerName;

        public string GetGmail(string cardNumber) => accounts[cardNumber].Gmail;

        public string GetColor(string cardNumber) => accounts[cardNumber].Color;
        ...
        {
            if (accounts.TryGetValue(cardNumber, out AccountData? value))
                return value.Pin.Equals(pin.Trim());
